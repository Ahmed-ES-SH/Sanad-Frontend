    ...
    >
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="relative">
          <Image
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuBu9siLVVryYlOMm6BpQrK6qbKNKC49N4e_JTh1DaUU6CzGi-yy_6i7Xu9rgYYu_x9UtXuNYey9Ggc11NVj5lbNmOQ6Pfg2AR42dKQ42TSCedO2mOBqCfvg5eMjSh1r6FvNHwQW4MGlKqC8R5rj6Uu1V8UXnKkwPfdrKuJ6fzCiHAOLCwZLDiNNy6M3GRqaNJp8LXPxsmBnV09kedfbLX3HpreUIODNRQbO7yiqqD_RJjc5UYb5MTt4Vs7MwNe_Rx0aR6vAblRwdIFu"
            alt={t.avatarAlt}
            width={128}
            height={128}
        ...
        <div className="flex flex-col gap-2">
          <button
            onClick={() => comingSoon(t.editProfile)}
            className="surface-btn-primary hover:shadow-surface-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
            {t.editProfile}
          </button>
          <button
            onClick={() => comingSoon(t.sharePortfolio)}
            className="surface-btn-secondary hover:shadow-surface-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
            {t.sharePortfolio}
          </button>
        </div>
