...
interface BasicInfoSectionProps {
  ...
  touched: Set<string>;
  errors: { title?: string; category?: string; shortDesc?: string; longDesc?: string };
          ...
          <div className="grid gap-6">
            ...
            <div className="grid gap-2">
              ...
              <p className="text-[11px] text-stone-400">
                {t?.basicInfo?.titleHelp || "A clear, descriptive title helps users find your project quickly."}
              </p>
            </div>
            ...
            <div className="grid gap-2">
              ...
              <select
                value={category}
                onChange={(e) => { setCategory(e.target.value); handleFieldChange("category", e.target.value); }}
                ...
                className={`w-full bg-stone-50 border-none rounded-lg p-4 focus:ring-2 focus:ring-orange-500/50 text-stone-800 appearance-none cursor-pointer ${
                  touched.has("category") && errors.category ? "ring-2 ring-red-400/40" : ""
                }`}
              >
                <option value="">
            ...
            <div className="grid gap-2">
              ...
              <div className={`bg-stone-50 rounded-lg border-none focus-within:ring-2 focus-within:ring-orange-500/50 transition-all overflow-hidden ${
                touched.has("longDesc") && errors.longDesc ? "ring-2 ring-red-400/40" : ""
              }`}>
                <textarea
                  value={longDesc}
              ...
              <p className="text-[11px] text-stone-400">
                {t?.basicInfo?.longDescHelp || "Optional but recommended — detailed descriptions improve SEO and user engagement."}
              </p>
            </div>
          </div>
        </div>
