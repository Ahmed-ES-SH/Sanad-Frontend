    ...
    <>
      ...
      >
        ...
        >
          <div className="space-y-3 min-w-0">
            ...
            >
              ...
              <span className="text-[#1c1917] font-medium truncate" title="NEOM Bridge Phase 2">
                NEOM Bridge Phase 2
              </span>
            </nav>
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            >
              ...
              <span className="relative z-10 whitespace-nowrap">Generate Report</span>
            </motion.button>
          </div>
            </motion.section>
        ...
        <div className="sr-only" aria-live="polite">
          Keyboard shortcuts: Press Escape to go back to projects list. 
          Press E to edit project. Press R to generate report.
        </div>
      </motion.main>
    </>
  );
